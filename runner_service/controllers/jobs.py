...
class ListEvents(BaseResource):
    ...
    def get(self, play_uuid=None):
        ...
        ```
        $ curl -k -i https://localhost:5001/api/v1/jobs/9c1714aa-b534-11e8-8c14-aced5c652dd1/events -X GET
        HTTP/1.0 200 OK
...
class GetEvent(BaseResource):
    ...
    def get(self, play_uuid, event_uuid):
        ...
        ```
        $ curl -k -i https://localhost:5001/api/v1/jobs/9c1714aa-b534-11e8-8c14-aced5c652dd1/events/2-0eaf70cd-0d86-4209-a3ca-73c0633afa27 -X GET
        HTTP/1.0 200 OK
        Content-Type: application/json
        Content-Length: 480
        Server: Werkzeug/0.14.1 Python/3.6.5
