...
class TestJobEvents(APITestCase):
    ...
    def test_list_job_events(self):
        ...
        response = self.get('/jobs/53b955f2-b79a-11e8-8be9-c85b7671906d/events')    # noqa
    ...
    def test_list_invalid_job(self):
        ...
        response = self.get("/jobs/93b955f2-b79a-11e8-8be9-c85b76719093/events")    # noqa
    ...
    def test_fetch_single_event(self):
        ...
        response = self.get("/jobs/53b955f2-b79a-11e8-8be9-c85b7671906d/events/49-e084d030-cd3d-4c76-a4d3-03d032c4dc8f") # noqa
    ...
    def test_fetch_invalid_event(self):
        ...
        response = self.get("/jobs/53b955f2-b79a-11e8-8be9-c85b7671906d/events/49-9384d030-cd3d-4c76-a4d3-03d032c4dc93")     # noqa
    ...
    def test_get_event_with_filter(self):
        ...
        response = self.get("/jobs/53b955f2-b79a-11e8-8be9-c85b7671906d/events?task=RESULTS")    # noqa
    ...
    def test_get_event_with_invalid_filter(self):
        ...
        response = self.get("/jobs/53b955f2-b79a-11e8-8be9-c85b7671906d/events?task=MISSING")    # noqa
