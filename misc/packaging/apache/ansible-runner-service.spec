...
%post
[[ -f /var/log/ovirt-engine/ansible-runner-service.log ]] && semanage fcontext -a -t httpd_log_t /var/log/ovirt-engine/ansible-runner-service.log && restorecon -r /var/log/ovirt-engine/ansible-runner-service.log
